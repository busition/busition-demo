...
export const consoleMetrics = [
  {
    label: "Live routes",
    value: "18",
    detail: "5 boarding now · 2 delayed",
  },
  {
    label: "Boarding certainty",
    value: "98.2%",
    detail: "Across academy, campus, and commute pilots",
  },
  {
    label: "Driver readiness",
    value: "24 / 26",
    detail: "Two drivers still in pre-service review",
  },
  {
    label: "Organizations online",
    value: "6",
    detail: "3 live today · 3 preparing launch",
  },
];
...
export const routeAssignments: RouteAssignment[] = [
  {
    ...
    notes: "Vehicle is ready, but the assigned driver reported unavailable before departure.",
    assignedDriverId: null,
  },
  {
    id: "kookmin-bulgwang-1",
    name: "Kookmin Univ to Bulgwang 1",
    ...
    punctuality: "97%",
    health: "Coverage gap",
    notes: "Recurring service is intact, but this route needs a new assigned driver after roster changes.",
    assignedDriverId: null,
  },
  {
    id: "kookmin-bulgwang-2",
    name: "Kookmin Univ to Bulgwang 2",
    organization: "Kookmin Shuttle Pilot",
    ...
    status: "Needs driver",
    punctuality: "96%",
    health: "Ready after assignment",
    notes: "Demand is lighter today, so standby coverage can absorb this route if needed.",
    assignedDriverId: null,
  },
  {
    id: "pangyo-gangnam-1",
    name: "Pangyo to Gangnam 1",
    organization: "Nexen Commute",
    departure: "Pangyo Tech Hub",
    arrival: "Gangnam Finance Center",
    departureTime: "07:10",
    serviceWindow: "Enterprise peak",
    seats: "32 seats",
    load: "27 / 32 riders",
    ...
    status: "Live now",
    punctuality: "99%",
    health: "Stable service",
    notes: "Vehicle departed on time with no active rider or operator exceptions.",
    assignedDriverId: "jeongheon-woo",
  },
  {
    id: "pangyo-gangnam-2",
    name: "Pangyo to Gangnam 2",
    organization: "Nexen Commute",
    ...
    status: "Delayed",
    punctuality: "88%",
    health: "Vehicle swap required",
    notes: "The first vehicle reported a charging issue. Dispatch needs to confirm the replacement bus.",
    assignedDriverId: "kyungmin-yoo",
  },
  {
    id: "gangnam-snu-1",
    name: "Gangnam to Seoul National University",
    ...
    status: "Ready",
    punctuality: "95%",
    health: "Boarding ready",
    notes: "Guardian notifications are enabled for all first-year riders on this route.",
...
export const driverRoster: DriverRecord[] = [
  {
    ...
    status: "On trip",
    zone: "Pangyo",
    assignedRoute: "Pangyo to Gangnam 1",
    vehicle: "Universe Prime",
    ...
    note: "Already in service with a strong punctuality record on peak commute corridors.",
  },
  {
    id: "kyungmin-yoo",
    name: "Kyungmin Yoo",
    status: "Review",
    zone: "Pangyo",
    assignedRoute: "Pangyo to Gangnam 2",
    vehicle: "Green City EV",
    ...
    note: "Needs vehicle handoff confirmation before the second departure can be cleared.",
  },
  {
    id: "junhyuk-kim",
    name: "Junhyuk Kim",
    status: "Available",
    zone: "South Seoul",
    assignedRoute: "Gangnam to Seoul National University",
    ...
    note: "Frequently assigned to guardian-sensitive routes because of strong boarding accuracy.",
  },
  {
    id: "seungmin-lee",
    name: "Seungmin Lee",
    ...
    note: "Available in 20 minutes after post-trip debrief and vehicle refueling.",
  },
];
...
export const dashboardAlerts = [
  {
    id: "alert-1",
    severity: "High",
    title: "Hongik Univ to Gangnam 1 needs a replacement driver",
    detail: "Coverage must be reassigned before 07:20 to avoid manual escalation across riders and staff.",
    time: "5 min ago",
  },
  {
    id: "alert-2",
    severity: "Medium",
    title: "Pangyo to Gangnam 2 reported a charging issue",
    detail: "Dispatch should confirm the replacement vehicle and notify riders before 07:30.",
    time: "12 min ago",
  },
  {
    id: "alert-3",
    ...
    detail: "No action needed. Boarding confirmation rules are already enabled for the route.",
    time: "24 min ago",
  },
];
