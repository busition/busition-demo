...
export const mateHero = {
  rider: "Jeongheon Woo",
  campus: "Kookmin University commuter service",
  eta: "Bus reaches your stop in 6 min",
  detail: "Linked with one guardian and one campus contact.",
};

export const timetableTrips: TimetableTrip[] = [
  {
    id: "bkg-live",
    routeName: "Bulgwang Line 3 Shuttle",
    state: "Live now",
    headline: "2 stops away",
    detail: "Heading to Hwagok Bokwang",
    accent: "bg-[#fff6e7]",
  ...
  },
  {
    ...
    detail: "Leaves at 15:30 for the return trip",
    accent: "bg-[#f5f5f4]",
  ...
  },
  {
    ...
    detail: "Heading to Main Campus Gate",
    accent: "bg-[#fff6e7]",
    statusTone: "text-[var(--accent-deep)]",
...
export const routeJourneys: RouteJourney[] = [
  {
    ...
    direction: "Nowon -> Kookmin Univ route",
    description: "The rider view keeps the map, live boarding count, and stop order in the same screen.",
    topLabel: "Morning pickup",
    detailLabel: "Live route",
    progress: "Vehicle is moving between stops",
  ...
  },
  {
    ...
    direction: "Kookmin Univ -> Bulgwang route",
    description: "Return trips stay visible for riders and guardians before class ends.",
    topLabel: "Afternoon return",
    detailLabel: "Scheduled route",
...
export const mateAlerts: MateAlert[] = [
  {
    ...
    detail: "Guardian view received the same confirmation instantly.",
    timestamp: "2 min ago",
    unread: true,
  },
  {
    id: "alert-2",
    category: "Service",
    title: "Route detail updated for the afternoon return line",
    detail: "The departure window remains 15:30. Stop order is unchanged.",
    timestamp: "24 min ago",
  },
  {
    id: "alert-3",
    category: "Delay",
    title: "Minor delay expected near Bulgwang Station",
  ...
  },
  {
    id: "alert-4",
    category: "Service",
    title: "Campus operations enabled guardian share links",
    detail: "One guardian and one staff contact are now linked to this rider account.",
...
export const familyMembers: FamilyMember[] = [
  {
    ...
    name: "Jeongheon Woo",
    role: "Primary rider",
    route: "Kookmin University morning line",
    status: "On route",
    badge: "2 stops away",
    badgeTone: "bg-[rgba(255,154,31,0.12)] text-[var(--accent-deep)]",
    note: "Boarding history, live ETA, and route detail are all shared with guardians.",
  },
  {
    id: "soojin-guardian",
    name: "Kyungmin Yoo",
    role: "Guardian access",
    route: "Shared live route",
    status: "Linked",
    badge: "Notifications on",
    badgeTone: "bg-[rgba(25,184,146,0.12)] text-[var(--success)]",
    note: "Receives boarding confirmation, arrival updates, and service notices.",
  },
  {
    id: "campus-contact",
    name: "Junhyuk Kim",
    ...
    note: "Acts as the service-side contact when route or stop information changes.",
  },
];
...
export const matePreferences = [
  {
    ...
    detail: "Send alerts when the rider boards or exits.",
    enabled: true,
  },
  {
    id: "pref-2",
    title: "ETA reminders",
    detail: "Notify 10 and 5 minutes before vehicle arrival.",
    enabled: true,
  },
  {
    id: "pref-3",
    title: "Delay alerts",
    detail: "Share route disruptions or detours automatically.",
    enabled: false,
  },
];
